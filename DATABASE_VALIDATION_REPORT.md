...
## Comptages
| Catégorie | Attendu | Réel (cible) | État |
|---|---|---|---|
| Comptes | 12 | — | ⏳ |
| Prospects | 42 | — | ⏳ |
| Paiements | 10 | — | ⏳ |
| Progression (modules) | 168 | — | ⏳ |
| Certificats | 7 | — | ⏳ |
| Tests (Option A) | 35 | — | ⏳ |
| Affiliation | 1 | — | ⏳ |
| Journaux | 14 | — | ⏳ |
...
## Intégrité (cible)
_Non évaluée (mode offline). Lancer `--check-target` après import pour les contrôles d'intégrité._

> Rapport en LECTURE SEULE — aucune donnée n'a été modifiée pour le produire.