  ...
  return (
    <section aria-labelledby="assessment-intro-title" className="mx-auto max-w-xl rounded-xl border border-[color:var(--border-gold)] bg-white p-6">
      ...
      <dl className="mt-4 grid grid-cols-2 gap-3 text-sm">
        <div><dt className="text-xs text-[color:var(--color-muted)]">Questions</dt><dd className="font-semibold text-[color:var(--color-navy)]">{model.questionCount}</dd></div>
        <div><dt className="text-xs text-[color:var(--color-muted)]">Durée indicative</dt><dd className="font-semibold text-[color:var(--color-navy)]">{model.indicativeMinutes} min</dd></div>
        <div><dt className="text-xs text-[color:var(--color-muted)]">Difficulté</dt><dd className="font-semibold text-[color:var(--color-navy)]">{model.difficultyKey}</dd></div>
        <div><dt className="text-xs text-[color:var(--color-muted)]">Tentative</dt><dd className="font-semibold text-[color:var(--color-navy)]">{model.attemptNumber} / {model.maxAttempts}</dd></div>
      </dl>
