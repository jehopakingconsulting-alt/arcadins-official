...
export const financeLessons: Lesson[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "À la réussite, l'attestation de complétion ARCADINS en gestion financière et comptabilité est délivrée. Elle atteste que vous avez suivi le programme et développé une compétence pratique immédiatement applicable en milieu de travail — la capacité de tenir, comprendre et interpréter la finance d'une PME canadienne.",
    ],
    caseStudy: {
    ...
    keyTakeaways: [
      ...
      "L'attestation délivrée certifie la complétion du programme et la maîtrise pratique des compétences",
    ],
    resources: [
    ...
    quiz: [
      ...
      { question: "Que certifie l'attestation de complétion délivrée ?", options: ["Un diplôme d'État reconnu par le gouvernement", "La complétion du programme ARCADINS et la maîtrise pratique des compétences", "Une équivalence universitaire internationale", "Une garantie d'embauche"], correctIndex: 1, explanation: "L'attestation atteste que l'étudiant a suivi le programme et développé les compétences visées ; elle ne constitue ni un diplôme officiel ni une garantie d'emploi." },
