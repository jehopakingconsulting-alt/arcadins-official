...
export const tourismeLessons: Lesson[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "À l'issue du stage et de l'évaluation, l'attestation de complétion ARCADINS en tourisme et gestion hôtelière est délivrée, sanctionnant les compétences pratiques développées pour le secteur touristique québécois.",
      "Cette attestation a une valeur concrète sur un marché du travail touristique en demande constante de personnel qualifié et fiable. Elle atteste non seulement de connaissances, mais d'une expérience pratique développée en contexte réel pendant le stage — un atout au moment de postuler. Elle peut ouvrir des portes, particulièrement pour les nouveaux arrivants qui cherchent une première expérience canadienne. Mais au-delà du document, le vrai acquis de la formation est la confiance opérationnelle : savoir accueillir, gérer, réagir et servir avec professionnalisme dans un secteur où l'humain et l'expérience sont au cœur de tout.",
    ],
    caseStudy: {
    ...
    keyTakeaways: [
      ...
      "L'attestation sanctionne une expérience pratique en contexte réel, utile aux nouveaux arrivants",
    ],
    resources: [],
    quiz: [
      ...
      { question: "Que sanctionne l'attestation délivrée à l'issue du programme ?", options: ["Un diplôme d'État reconnu par le gouvernement", "La complétion du programme et une expérience pratique développée en stage", "Une équivalence universitaire internationale", "Une garantie d'embauche"], correctIndex: 1, explanation: "L'attestation atteste de la complétion du programme et de l'expérience pratique acquise ; elle ne constitue ni un diplôme officiel ni une garantie d'emploi." },
