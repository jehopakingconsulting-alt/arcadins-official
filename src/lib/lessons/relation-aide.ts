...
export const relationAideLessons: Lesson[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "L'attestation de complétion ARCADINS en relation d'aide et service communautaire, délivrée à l'issue du stage et de l'évaluation, atteste d'une compétence pratique orientée vers des postes d'intervention de première ligne.",
      "Cette attestation a une valeur concrète dans un secteur qui a un besoin réel d'intervenants formés, humains et fiables. Elle atteste non seulement de connaissances, mais d'une compétence pratique développée auprès de vraies personnes, sous supervision, pendant le stage — un atout au moment de postuler pour des situations sensibles. Elle peut ouvrir des portes, notamment pour les nouveaux arrivants cherchant à s'engager dans un métier de sens. Mais au-delà du document, le véritable acquis de cette formation est une posture : savoir écouter vraiment, accompagner sans juger, respecter l'autonomie et les limites, et prendre soin des autres sans se détruire soi-même. L'attestation atteste ; c'est cette posture humaine et professionnelle qui fera la différence, pour l'intervenant comme pour ceux qu'il accompagnera.",
    ],
    caseStudy: {
    ...
    quiz: [
      ...
      { question: "Que représente l'attestation délivrée à l'issue du programme ?", options: ["Un diplôme d'État reconnu par le gouvernement", "La complétion du programme et une compétence pratique développée sous supervision", "Une équivalence universitaire internationale", "Une garantie d'embauche"], correctIndex: 1, explanation: "L'attestation atteste de la complétion du programme et de la compétence pratique acquise en stage ; elle ne constitue ni un diplôme officiel ni une garantie d'emploi." },
