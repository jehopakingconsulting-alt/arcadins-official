...
export const PROGRAM_PLANS: ProgramPlan[] = [
  {
    ...
    features: [
      { text: "Accès complet aux modules de préparation TEF/TCF", included: true },
      { text: "Test de qualification inclus", included: true },
      { text: "Test final · 1 tentative", included: true },
      { text: "Support par email", included: true },
      { text: "Certificat de complétion ARCADINS", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Certificat de complétion ARCADINS", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Accompagnement jusqu'au jour J", included: false },
    ],
  },
  {
    key: "vip",
    ...
    features: [
      ...
      { text: "Accompagnement jusqu'au jour J", included: true },
