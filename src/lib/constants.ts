...
export const PROGRAMS: Program[] = [
  { id: "1", slug: "francais-tef-tcf", icon: "🇫🇷", category: "lang", categoryLabel: "Langue", name: "Français Intensif TEF/TCF Canada", description: "Maîtrisez les 4 compétences linguistiques exigées. Coaching oral inclus.", duration: "12 semaines", certification: "Certifié", link: "/tef" },
  { id: "2", slug: "francais-affaires", icon: "🗣️", category: "lang", categoryLabel: "Langue", name: "Français des Affaires & du Travail", description: "Vocabulaire professionnel, communication d'entreprise en français québécois.", duration: "8 semaines", certification: "Certifié", link: "/tarifs" },
  { id: "3", slug: "leadership", icon: "👑", category: "biz", categoryLabel: "Leadership", name: "Leadership & Gestion d'Équipe", description: "Développez des compétences pour diriger et motiver une équipe multiculturelle.", duration: "10 semaines", certification: "Certifié", link: "/tarifs" },
  { id: "4", slug: "finance", icon: "📊", category: "biz", categoryLabel: "Finance", name: "Gestion Financière & Comptabilité", description: "Gestion financière, analyse de bilan, planification budgétaire et comptabilité.", duration: "10 semaines", certification: "Certifié", link: "/tarifs" },
  { id: "5", slug: "entrepreneuriat", icon: "🚀", category: "biz", categoryLabel: "Entrepreneuriat", name: "Entrepreneuriat & Innovation", description: "Créer et gérer une entreprise au Canada. Plan d'affaires et financement.", duration: "12 semaines", certification: "Certifié", link: "/tarifs" },
  { id: "6", slug: "rh", icon: "🤝", category: "biz", categoryLabel: "RH", name: "Ressources Humaines & Talents", description: "Droit du travail québécois, gestion des talents et recrutement.", duration: "8 semaines", certification: "Certifié", link: "/tarifs" },
  { id: "7", slug: "informatique", icon: "💻", category: "tech", categoryLabel: "Technologie", name: "Informatique & Transformation Digitale", description: "Cloud, IA appliquée, sécurité informatique et digitalisation des processus.", duration: "12 semaines", certification: "Certifié", link: "/tarifs" },
  { id: "8", slug: "marketing-digital", icon: "🌐", category: "tech", categoryLabel: "Digital", name: "Marketing Digital & E-commerce", description: "SEO/SEM, réseaux sociaux et création de boutiques en ligne.", duration: "8 semaines", certification: "Certifié", link: "/tarifs" },
  { id: "9", slug: "epe", icon: "👶", category: "soc", categoryLabel: "Éducation", name: "Éducatrice à la Petite Enfance (EPE)", description: "Formation reconnue Québec. Environnement éducatif 0–5 ans.", duration: "16 semaines", certification: "Reconnu QC", link: "/tarifs" },
  { id: "10", slug: "pab", icon: "🩺", category: "soc", categoryLabel: "Soins", name: "Préposé(e) aux Bénéficiaires (PAB)", description: "Formation PAB reconnue MSSS Québec. Soins aux personnes vulnérables.", duration: "20 semaines", certification: "MSSS QC", link: "/tarifs" },
  { id: "11", slug: "immigration-agent", icon: "🏛️", category: "leg", categoryLabel: "Immigration", name: "Agent(e) de Soutien en Immigration", description: "Formation complète : dossiers IRCC, formulaires, procédures et accompagnement.", duration: "14 semaines", certification: "Certifié", link: "/tarifs" },
  { id: "12", slug: "famille-sans-dette", icon: "💰", category: "leg", categoryLabel: "Finance personnelle", name: "Famille Sans Dette", description: "Budget familial, crédit, épargne et planification pour nouveaux arrivants.", duration: "6 semaines", certification: "Certifié", link: "/tarifs" },
];
