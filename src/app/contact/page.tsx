        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-14 items-start">
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-[28px] p-10 border border-gold/17 shadow-[0_8px_40px_rgba(13,27,46,0.07)]">
            ...
            <div className="grid grid-cols-2 gap-3.5 mb-3.5">
              <div><label className="block text-[12.5px] font-semibold text-body mb-1.5">{t(UI["contact.form.first"], lang)}</label><input name="firstName" type="text" required aria-label={t(UI["contact.form.first"], lang)} className="w-full px-4 py-3 border-[1.5px] border-gold/20 rounded-xl text-sm text-body bg-off-white outline-none focus:border-gold focus:bg-white transition-all" /></div>
              <div><label className="block text-[12.5px] font-semibold text-body mb-1.5">{t(UI["contact.form.last"], lang)}</label><input name="lastName" type="text" required aria-label={t(UI["contact.form.last"], lang)} className="w-full px-4 py-3 border-[1.5px] border-gold/20 rounded-xl text-sm text-body bg-off-white outline-none focus:border-gold focus:bg-white transition-all" /></div>
            </div>
            <div className="mb-3.5"><label className="block text-[12.5px] font-semibold text-body mb-1.5">{t(UI["contact.form.email"], lang)}</label><input name="email" type="email" required aria-label={t(UI["contact.form.email"], lang)} className="w-full px-4 py-3 border-[1.5px] border-gold/20 rounded-xl text-sm text-body bg-off-white outline-none focus:border-gold focus:bg-white transition-all" /></div>
            <div className="mb-3.5"><label className="block text-[12.5px] font-semibold text-body mb-1.5">{t(UI["contact.form.country"], lang)}</label><input name="country" type="text" aria-label={t(UI["contact.form.country"], lang)} className="w-full px-4 py-3 border-[1.5px] border-gold/20 rounded-xl text-sm text-body bg-off-white outline-none focus:border-gold focus:bg-white transition-all" /></div>
            <div className="mb-3.5"><label className="block text-[12.5px] font-semibold text-body mb-1.5">{t(UI["contact.form.interest"], lang)}</label>
              <select name="interest" aria-label={t(UI["contact.form.interest"], lang)} className="w-full px-4 py-3 border-[1.5px] border-gold/20 rounded-xl text-sm text-body bg-off-white outline-none focus:border-gold focus:bg-white transition-all">
