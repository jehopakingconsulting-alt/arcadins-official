          ...
          <div className="p-8 grid grid-cols-1 lg:grid-cols-[1fr_295px] gap-8">
            <div>
              ...
              <div className="flex flex-col gap-2">
                {[{l:"A",t:"Les opportunités d'emploi dans le secteur technologique"},{l:"B",t:"La vitalité culturelle et la langue française comme langue commune",s:true},{l:"C",t:"Le système de santé universel et les allocations familiales"},{l:"D",t:"La proximité géographique avec les États-Unis"}].map((o) => (
            ...
            <div className="hidden lg:block">
              <div className="bg-white/[0.046] border border-gold/17 rounded-xl p-5 mb-3">
                <div className="text-gold text-[11px] font-bold tracking-[2px] uppercase mb-3">Score</div>
                <div className="text-center mb-3"><div className="font-[family-name:var(--font-heading)] text-[22px] font-bold text-white">B2</div><div className="text-[10px] text-white/38">Niveau</div></div>
                <div className="space-y-1 text-xs">
                  <div className="flex justify-between"><span className="text-white/46">Compréhension Orale</span><span className="text-gold">B2</span></div>
                  <div className="flex justify-between"><span className="text-white/46">Expression Écrite</span><span className="text-gold">B1</span></div>
                  <div className="flex justify-between"><span className="text-white/46">Expression Orale</span><span className="text-white/30">En cours…</span></div>
                </div>
              </div>
              <div className="bg-gradient-to-br from-gold/13 to-gold/4 border border-gold/27 rounded-xl p-5 text-center">
                <div className="text-gold font-[family-name:var(--font-heading)] text-sm mb-1.5">🏆 Certificat Numérique</div>
                <div className="text-white/42 text-xs leading-[1.5] mb-3">QR code de vérification officielle</div>
              </div>
              <div className="bg-white/[0.046] border border-gold/17 rounded-xl p-5 mt-3">
                <div className="text-gold text-[11px] font-bold tracking-[2px] uppercase mb-2">Sécurité</div>
                <div className="flex items-center gap-2 text-[13px] text-white/52"><span className="w-[9px] h-[9px] rounded-full bg-[#28c840] animate-blink shrink-0" />Session Proctor IA active</div>
              </div>
            </div>
          </div>
        </div>
